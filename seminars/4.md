...
::: {.callout-note}
## Given
$X \in \mathbb{R}^{m \times n}, y \in \{0, 1\}^n$ - data
:::
...
TODO: add some picture releated to log-reg, notebook for log-reg experiment, do the same for SVM, slide on couple other important examples without proof and code.