...
:::
::: {.column width=38%}
![Convexity of Logistic Loss in Parameter Space for x=(1,1), y=1](../files/logloss_3d_surface.png)  
:::
:::
...
Check the [\faPython\ logistic regression experiments](https://colab.research.google.com/github/MerkulovDaniil/hse25/blob/main/notebooks/s4_benchmarx_logreg.ipynb)

## Support Vector Machine (SVM)

<!-- TODO: do the same for SVM, slide on couple other important examples without proof and code. -->
